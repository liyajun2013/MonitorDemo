...
object Tracker {
    ...
    internal lateinit var trackContext: Context
    ...
    fun initialize(app: Application) {
        ...
        trackContext = app.getApplicationContext()
    ...
    fun trackView(view: View) {
        val trackProperties = view.getTrackProperties()
    ...
    fun trackAdapterView(adapterView: AdapterView<*>, view: View, position: Int, id: Long,
