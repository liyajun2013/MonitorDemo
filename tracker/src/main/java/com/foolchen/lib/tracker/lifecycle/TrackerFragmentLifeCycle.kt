 ...
 * 上午11:27
 */
object TrackerFragmentLifeCycle {

    val refs = ArrayList<WeakReference<Fragment>>()
    val trackedRefs = WeakHashMap<Fragment, Boolean>()

    fun onFragmentResumed( f: Fragment?) {
        if (f != null) {
    ...
    fun onFragmentPaused(f: Fragment?) {
